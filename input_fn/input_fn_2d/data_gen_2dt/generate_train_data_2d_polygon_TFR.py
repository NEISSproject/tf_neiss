...
if __name__ == "__main__":
    ...
    t2d_saver_obj = tfr_helper.Polygon2dSaver(epsilon=0.1, phi_arr=phi_arr, samples_per_file=samples_per_file,
    ...
    parsed_dataset_batched = parsed_dataset.padded_batch(10, ({'fc': [3, None]}, {'points': [None, 2], 'edges': [1]}),
